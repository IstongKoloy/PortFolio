...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_nrijoer', 'template_ktr1o0t', form.current, 'BeWBBBkzlxxaYx4Ee')
        .then(() => {
            e.target.reset();
            setVisible(true);
        }, (error) => {
  ...
  return (
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">andaleon34@gmail.com</span>

                        <a href="mailto:andaleon34@gmail.com" className="contact__button">Message me
            ...
            <div className="contact__content">
                <h3 className="contact__title">Message me your project</h3>
                ...
                <form ref={form} className="contact__form" onSubmit={sendEmail}>
                    ...
                    <div className="contact__form-div contact__form-area">
                        ...
                        <textarea name='message' className='contact__form-input' cols="30" rows="10" placeholder='Write your message' required></textarea>
                    </div>
